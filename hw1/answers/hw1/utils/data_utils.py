...
def get_train_and_test_set():
    ...
    '''
    transform = transform_cifar10()  # Get the transformations
...
def get_testloader(test_set, test_indices, batch_size):
    ...
    '''
    test_set = Subset(test_set, test_indices)  # Create a subset based on test indices
...
def get_validationloader(test_set, val_indices, batch_size):
    ...
    '''
    valset = Subset(test_set, val_indices)  # Create a subset for validation
